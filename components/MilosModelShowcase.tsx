...
import styles from "./MilosModelShowcase.module.css";

interface MilosModelShowcaseProps {
...
export const MilosModelShowcase: React.FC<MilosModelShowcaseProps> = ({ model }) => {
  const milosFeatures = [
    ...
    <div className={styles.showcase}>
      <div className={styles.modelInfo}>
        ...
        <div className={styles.features}>
          {milosFeatures.map((feature, index) => (
      ...
      <div className={styles.floorPlan}>
        <img
          src="https://assets.floot.app/db2f7462-5369-478c-a930-83c9e7fb716f/77b78fb7-e1a5-43a8-89e8-2c928d2ec981.gif"
          alt="Plano del modelo Milos - Las Ceibas Manzanillo"
          className={styles.floorPlanImage}
        />
        <p className={styles.floorPlanCaption}>Plano arquitectónico del modelo Milos</p>
      </div>
    </div>
  );
};